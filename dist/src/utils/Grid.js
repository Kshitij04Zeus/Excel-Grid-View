...
export class Grid {
    ...
    statusBarManager;
    scrollBarManager;
    constructor(datastore, viewport, canvasElement) {
        ...
        this.formulaBarManager = new FormulaBarManager(this.datastore, this.selectionManager, this.commandManager, () => this.render());
        this.keyboardManager = new KeyboardManager(this.selectionManager, this.commandManager, this.datastore, this.viewport, this.canvas, () => this.render());
        this.coordinateManager = new CoordinateManager(this.datastore, this.viewport);
        this.mouseManager = new MouseManager(this.canvas, this.datastore, this.viewport, this.selectionManager, this.resizeManager, this.editManager, this.commandManager, this.coordinateManager, this.scrollBarManager, () => this.render());
        this.statusBarManager = new StatusBarManager(this.selectionManager, this.datastore);
